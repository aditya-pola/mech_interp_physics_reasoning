# Code adapted from https://github.com/davidbau/baukit/blob/main/baukit/nethook.py
    ...
    if isinstance(x, dict):
        ...
        for v in x:
            ...
            if type(x) == torch.Tensor:
                _dummy.append(recursive_copy(v, clone=clone, detach=detach, retain_grad=retain_grad))  
        return type(x)(_dummy)
    else:
